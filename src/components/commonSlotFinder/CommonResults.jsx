...
export default function CommonResults({ commonSlots, DAYS, exportCommonSlots }) {
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-lg font-semibold text-gray-800">
            Results: Batch {commonSlots.batch}, Semester {commonSlots.semester}
          </h3>
          <p className="text-sm text-gray-600">
            Checking {commonSlots.sections.length} sections: {commonSlots.sections.map(s => s.split('_').pop()).join(', ')}
          </p>
        </div>
